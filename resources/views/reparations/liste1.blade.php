        ...
        @foreach ($reparations as $rp)
            <tr id="row{{$rp->id}}">
               ...
               <td> {{$rp->nom_mecaniciens}}</td>
                ...
                <td>
                    <a class="btnEdit btn  bg-blue-500 hover:bg-blue-400 text-white font-bold  px-2 border-b-4 border-blue-700 hover:border-blue-500 rounded" href="{{route('reparations.edit',$rp->id)}}">@lang('Modifier')</a>
                </td>
            </tr>
        @endforeach
    </table>
