...
<div class="row">
    <div class="col-lg-12 mt-10" >
        ...
        <div class="pull-right"style="margin-left:20px">
            <a class="btn y" href="{{ route('reparations.index') }}" style="background: #FAEF5D; margin-bottom: 30px">@lang('Retourner')</a>
        </div>
    </div>
</div>
...
@endif
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
        <button type="submit" class="btn" style="background-color: #23049D; color: #ffffff; margin-bottom:30px">@lang('Creer')</button>
    </div>
    </form>
