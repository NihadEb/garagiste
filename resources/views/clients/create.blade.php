...
<form action="{{ route('clients.store') }}" method="POST" class="m-10">
    @csrf
    ...
    <table class="table" style="border: 2px solid #FAEF5D;">
        <tbody>
            ...
            <tr>
                ...
                <td><input class="form-control" name="prenom" placeholder="prenom ..."></td>
            </tr>
            <tr>
                <td><strong>@lang('Telephone') :</strong></td>
                <td><input class="form-control" name="telephone" placeholder="telephone ..."></td>
            </tr>
            <tr>
                <td><strong>@lang('Adresse') :</strong></td>
                <td><input class="form-control" name="adresse" placeholder="adresse..."></td>
            </tr>
            <tr>
            ...
            <!-- Ajoutez ici d'autres champs de formulaire au besoin -->
        </tbody>
    </table>
