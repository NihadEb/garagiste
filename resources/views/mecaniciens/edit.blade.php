...
<div class="row">
    <div class="col-lg-12 mt-10" >
        ...
        <div class="pull-right"style="margin-left:800px">
            <a class="btn btn-primary" href="{{ route('mecaniciens.index') }}">@lang('Retourner')</a>
        </div>
    </div>
</div>
...
<form action="{{ route('mecaniciens.update',$meca->id) }}" method="POST" class="m-10">
    @csrf
    @method('PUT')
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nom" class="form-control" placeholder="nom.." value="{{ $meca->nom }}">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Prenom') :</strong>
                <input class="form-control " name="prenom" placeholder="prenom ..." value="{{ $meca->prenom }}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong>@lang('Telephone') :</strong>
                <input class="form-control"  name="telephone" placeholder="telephone ..."  value="{{ $meca->telephone}}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Adresse') :</strong>
                <input class="form-control"  name="adresse" placeholder="adresse..." value="{{ $meca->adresse }}"></input>
            </div>
        </div>
