...
@endif
    <form action="{{ route('mecaniciens.store') }}" method="POST" class="m-10" style="border: 2px solid #FAEF5D;"">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                ...
                <input class="form-control " name="prenom" placeholder="prenom ..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                ...
                <input class="form-control"  name="adresse" placeholder="adresse..."></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn-success">@lang('Enregister')</button>
        </div>
    </div>
