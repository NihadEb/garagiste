...
<img src="https://i.pinimg.com/564x/a4/84/6e/a4846e9523fe38ed3355e5254888a3c9.jpg" alt="Mechanic" class="mechanic-image">
<div class="wrapper">
  <form method="POST" action="{{ route('register.post') }}">
    @csrf
    <h1 style="font-weight:bolder; font-size:30px ;color:black">S'inscrire</h1>
    <div class="input-box">
      <input type="text" placeholder="Nom complet" id="name" name="name" required autofocus>
      <i class='bx bxs-user' style="color: rgb(236, 236, 52)"></i>
      @if ($errors->has('name'))
    ...
    <div class="input-box">
      ...
      <i class='bx bxs-envelope' style="color: rgb(236, 236, 52)"></i>
      @if ($errors->has('email'))
    ...
    <div class="input-box">
      ...
      <i class='bx bxs-home' style="color: rgb(236, 236, 52)"></i>
    ...
    <div class="input-box">
      ...
      <i class='bx bxs-phone'style="color: rgb(236, 236, 52)"></i>
    ...
    <div class="input-box">
      ...
      <i class='bx bxs-lock-alt'style="color: rgb(236, 236, 52)"></i>
