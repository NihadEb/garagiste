...
<body>
  ...
  <div class="wrapper">
    <form method="POST" action="{{ route('login.post') }}">
      @csrf
      <h1 style="font-weight:bolder; font-size:30px ;color:black">Se connecter</h1>
      <div class="input-box">
  ...
  <img src="{{asset('https://i.pinimg.com/564x/12/9c/f3/129cf35b4ffb613531768b5517a97e34.jpg')}}" alt="Mechanic" class="mechanic-image">
</body>
</html>
