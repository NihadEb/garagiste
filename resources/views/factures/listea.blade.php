    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake"
                src="{{ asset('https://i.pinimg.com/564x/c2/38/ca/c238ca771e6b506dc93bf69b642559d7.jpg') }}"
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="m-5">
                    <a class="btn " href="{{route('factures.create')}}" style="background-color: #23049D; color: #FFFFFF;">@lang('Ajouter une reparation')</a>
                        <a href="{{route('generate-pdff')}}">
