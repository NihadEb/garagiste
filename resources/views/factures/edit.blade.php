...
<div class="preloader flex-column justify-content-center align-items-center">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div class="container">
        <h2>Modifier  une facturation</h2>
        <form action="{{ route('factures.update',$fc->id) }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="chargeSupp" class="form-label">Charge supplimentaire</label>
                <input type="text" class="form-control" id="chargeSupp" name="chargeSupp" >
            </div>
            <div class="mb-3">
                <label for="reparation_id" class="form-label">Reparation</label>
