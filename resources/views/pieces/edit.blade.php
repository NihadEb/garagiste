...
<div class="row">
    <div class="col-lg-12 mt-10" >
        ...
        <div class="pull-right"style="margin-left:800px">
            <a class="btn btn-primary" href="{{ route('pieces.index') }}">@lang('Retourner')</a>
        </div>
    </div>
</div>
...
<form action="{{ route('pieces.update',$p->id) }}" method="POST" class="m-10">
    @csrf
    @method('PUT')
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nompiece" class="form-control" placeholder="nom piece.." value="{{ $p->nompiece}}">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Reference') :</strong>
                <input class="form-control " name="referencep" placeholder="reference ..." value="{{ $p->referencep }}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong>@lang('Fournisseur') :</strong>
                <input class="form-control"  name="fournisseur" placeholder="fournisseur ..."  value="{{ $p->fournisseur}}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Prix') :</strong>
                <input class="form-control"  name="prix" placeholder="prix..." value="{{ $p->prix }}"></input>
            </div>
        </div>
