...
use Illuminate\Support\Facades\Session; // Ajout du use pour Session
use Illuminate\Support\Facades\Hash; // Ajout du use pour Hash
...
class AuthController extends Controller
{
    ...
    public function create(array $data)
    {
        ...
        $user = User::create([
            'name' => $data['name'],
            'email' => $data['email'],
            'password' => Hash::make($data['password']) // Utilisation de la méthode Hash::make pour hacher le mot de passe
        ]);
