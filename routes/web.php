...
// mecanciens
    ...
    Route::get('/generate-pdfr', [PDFController::class, 'generatePDFr'])->name('generate-pdfr');
...
Route::get('/vehicules/login', function () {
    // Traitement pour la connexion des véhicules
})->name('vehicules.login');

Route::post('/vehicules/login', function () {
    // Traitement pour la connexion des véhicules (POST)
});
